...
OPS=(
  ...
  "wraplp|perop|exec-wraplp.rs|OP_FILE=$FX/wraplp_op.json"
  "wrapswap|perop|exec-wrapswap.rs|OP_FILE=$FX/wrapswap_op.json"
  "stealthlock|perop|exec-stealthlock.rs|OP_FILE=$FX/stealthlock_op.json"
  "bridgemint|perop|exec-bridgemint.rs|OP_FILE=$FX/bridgemint_op.json"
