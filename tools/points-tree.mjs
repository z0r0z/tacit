...
//
// Canonical copy — worker-relay/src/lib/points-merkle.js vendors this file's core (leafHash/buildTree/proofFor/
// build) because that service's Docker build context can't reach this repo-root directory. Keep them in sync.
//
