...
const batch = {
  ...
  blocks: [
    ...
    { txs: [
      ...
      { txData: '0xfeed02', txid: v(0x73), vins: [{ prevTxid: txid1, vout: 1 }], env: { type: 'burn', assetId, nullifier: pool.nullifier(pool.btcNoteLeaf(assetId, out1.cx, out1.cy, ZERO_AUTH)), dest: v(0xde) } },
    ] },
  ],
};
