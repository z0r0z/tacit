...
/// Proof fixture: contracts/test/fixtures/stealthlock_groth16.json (the box produces it).
contract ConfidentialStealthLockProofRealTest is Test {
    ...
    function setUp() public {
        ...
        string memory json = vm.readFile(string.concat(vm.projectRoot(), "/test/fixtures/stealthlock_groth16.json"));
    ...
    /// The real OP_STEALTH_LOCK proof verifies on-chain against the current pinned vkey.
