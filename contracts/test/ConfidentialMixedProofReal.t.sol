...
/// Proof fixture: contracts/test/fixtures/mixed_groth16.json (the box produces it).
contract ConfidentialMixedProofRealTest is Test {
    ...
    function setUp() public {
        ...
        string memory json = vm.readFile(string.concat(vm.projectRoot(), "/test/fixtures/mixed_groth16.json"));
