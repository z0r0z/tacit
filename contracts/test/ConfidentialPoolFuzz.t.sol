...
contract ConfidentialPoolFuzzTest is Test {
    ...
    function setUp() public {
        ...
        pool = new ConfidentialPool(address(verifier), bytes32(uint256(1)), bytes32(0), address(0), address(0), bytes32(0), 6, bytes32(0), bytes32(0), address(0), address(0), address(0));
    }
