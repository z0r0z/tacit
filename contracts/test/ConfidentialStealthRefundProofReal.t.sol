...
contract ConfidentialStealthRefundProofRealTest is Test {
    ...
    function setUp() public {
        ...
        string memory json = vm.readFile(string.concat(vm.projectRoot(), "/test/fixtures/stealthrefund_groth16.json"));
