...
// Like exec-bridgemint, but the destination is a stealth lock (dest_leaf = stealth_lock_leaf) appended to the
...
// inCy(32) ‖ inOwner(32) ‖ inIndex(u64) ‖ inPath[32] ‖ ownerPub(32) ‖ amount(u64) ‖ deadline(u64) ‖ locker(32)
// ‖ lCx(32) ‖ lCy(32) ‖ lSigR(33) ‖ lSigZ(32) ‖ bmNext(32) ‖ bmIndex(u64) ‖ bmPath[32] ‖ kernelR(33) ‖ kernelZ(32).
