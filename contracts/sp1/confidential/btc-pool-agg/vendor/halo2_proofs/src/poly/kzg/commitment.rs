    ...
    E::G1: CurveExt<AffineExt = E::G1Affine>,
{
    ...
    /// Verifier-only parameters: g[0], g2, s_g2 (the only parts a KZG verifier reads).
    pub fn verifier_only(k: u32, g0: E::G1Affine, g2: E::G2Affine, s_g2: E::G2Affine) -> Self {
        Self { k, n: 1 << k, g: vec![g0], g_lagrange: vec![], g2, s_g2 }
    }
