    ...
    C::Scalar: SerdePrimeField + FromUniformBytes<64>,
{
    ...
    pub fn read<R: io::Read, ConcreteCircuit: Circuit<C::Scalar>>(
        ...
        Self::read_with_repr::<R, ConcreteCircuit>(
            reader,
            format,
    ...
    /// As `read`; with `repr = Some(r)` the transcript representation is taken as given instead
    /// of hashed from the pinned key (the caller must bind `r` to the key some other way).
    pub fn read_with_repr<R: io::Read, ConcreteCircuit: Circuit<C::Scalar>>(
        reader: &mut R,
        format: SerdeFormat,
        #[cfg(feature = "circuit-params")] params: ConcreteCircuit::Params,
        repr: Option<C::Scalar>,
    ) -> io::Result<Self> {
        ...
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-start: vk_configure");
        ...
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-end: vk_configure");
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-start: vk_read_commitments");
        ...
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-end: vk_read_commitments");
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-start: vk_selectors_compress");
        ...
        let (cs, selectors) = if compress_selectors {
            ...
            let selectors: Vec<Vec<bool>> = vec![vec![false; 1 << k]; cs.num_selectors]
                ...
                .collect::<io::Result<_>>()?;
            #[cfg(feature = "fast-vk-read")]
            let cs = cs.compress_selectors_verifier(selectors.clone());
            #[cfg(not(feature = "fast-vk-read"))]
        ...
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-end: vk_selectors_compress");

        Ok(Self::from_parts_with_repr(
            domain,
            fixed_commitments,
            permutation,
            cs,
...
impl<C: CurveAffine> VerifyingKey<C> {
    ...
    {
        Self::from_parts_with_repr(domain, fixed_commitments, permutation, cs, selectors, compress_selectors, None)
    }

    #[allow(clippy::too_many_arguments)]
    fn from_parts_with_repr(
        domain: EvaluationDomain<C::Scalar>,
        fixed_commitments: Vec<C>,
        permutation: permutation::VerifyingKey<C>,
        cs: ConstraintSystem<C::Scalar>,
        ...
        C::ScalarExt: FromUniformBytes<64>,
    {
        ...
        if let Some(r) = repr {
            vk.transcript_repr = r;
            return vk;
        }
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-start: vk_transcript_repr");
        ...
        #[cfg(target_os = "zkvm")]
        println!("cycle-tracker-report-end: vk_transcript_repr");
